<div id="comments">
	...
	<span class="widget-title1"><?php $this->commentsNum(_t('暂无评论'), _t('仅有 1 条评论'), _t('已有 %d 条评论')); ?></span>
    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
    	...
    	<span id="response" class="widget-title1"><?php _e('添加新评论'); ?></span>
    	<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form">
			<div class="col1">
			<p>
                <textarea required oninvalid="setCustomValidity('评论不能为空！')" oninput="setCustomValidity('')"  rows="8" cols="50" name="text" class="textarea" placeholder="在这里输入你的评论..."><?php $this->remember('text'); ?></textarea>
            </p>
			</div>
			<div class="col2">
